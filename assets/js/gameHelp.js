...
var godsLibrary = ["mercury", "hermes", "venus", "aphrodite"]; 


/*"mars", "ares", "jupiter", "zeus", "saturn", "kronos", "uranus", "ouranos", "neptune", "poseidon"];*/
...
var musicLibrary = ['assets/music/merc.mp3', 'assets/music/merc.mp3', 'assets/music/ven.mp3', 'assets/music/ven.mp3'];
...
var index = Math.floor(Math.random() * godsLibrary.length);

var randomPick = godsLibrary[index];
...
document.onkeyup = function(event)
{
	...
	if(randomPick == godsLibrary[0] || randomPick == godsLibrary[1]){
		var audio = new Audio(musicLibrary[index]);
		audio.play();
	}
